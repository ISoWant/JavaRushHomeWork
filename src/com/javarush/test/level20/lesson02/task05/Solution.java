...
public class Solution {
    ...
    public static class Object {
        ...
        public void save(OutputStream outputStream) throws Exception {
            ...
            PrintStream toFile = new PrintStream(byteArray);
        ...
        public synchronized void load(InputStream inputStream) throws Exception {
            BufferedReader fileRd = new BufferedReader(new InputStreamReader(inputStream));

            if (fileRd.ready()) {
                java.lang.String firstString = fileRd.readLine();
                java.lang.String secondString = fileRd.readLine();

                int tmp = countStrings;
                if (firstString == null) {
                    this.string1 = null;
                } else {
                    countStrings = Integer.parseInt(firstString.split("#")[1]) - 1;
                    this.string1 = new String();
                }
                if (secondString == null) {
                    this.string2 = null;
                } else {
                    countStrings = Integer.parseInt(secondString.split("#")[1]) - 1;

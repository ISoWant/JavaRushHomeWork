...
public class Solution {
    ...
    public static class ClassWithStatic {
        ...
        public void save(OutputStream outputStream) throws Exception {
            ...
            outputStream.write('\n');
            outputStream.write((this.i+"").toString().getBytes());
            outputStream.write('\n');
            outputStream.write((this.j+"").toString().getBytes());
            outputStream.write('\n');
        ...
        public void load(InputStream inputStream) throws Exception {
            if (inputStream.available() != 0) {
                staticString = readParameter(inputStream);
                this.i = Integer.parseInt(readParameter(inputStream));
                this.j = Integer.parseInt(readParameter(inputStream));
            }
            //implement this method - реализуйте этот метод
        }

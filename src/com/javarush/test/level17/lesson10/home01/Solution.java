...
/* Общий список
1. Изменить класс Solution_old так, чтобы он стал списком. (Необходимо реализовать интерфейс java.util.List).
2. Список Solution_old должен работать только с целыми числами Long.
